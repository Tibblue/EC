...
-- -----------------------------------------------------
-- Table `datawarehouse`.`dim_supplier`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `datawarehouse`.`dim_local`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `datawarehouse`.`dim_local` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `datawarehouse`.`dim_product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `datawarehouse`.`dim_product` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `id_p` INT NOT NULL,
  `name` VARCHAR(45) NOT NULL,
...
-- -----------------------------------------------------
-- Table `datawarehouse`.`dim_shipper`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `datawarehouse`.`dim_shipper` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `id_sh` INT NOT NULL,
  `name` VARCHAR(45) NOT NULL,
  `last_update` TIMESTAMP NOT NULL,
...
-- -----------------------------------------------------
-- Table `datawarehouse`.`dim_employee`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `datawarehouse`.`dim_employee` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `id_e` INT NOT NULL,
  `name` VARCHAR(45) NOT NULL,
  `company` VARCHAR(45) NOT NULL,
...
-- -----------------------------------------------------
-- Table `datawarehouse`.`sales_fact`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `datawarehouse`.`sales_fact` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_sales_fact_dim_local1`
    ...
    REFERENCES `datawarehouse`.`dim_local` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
